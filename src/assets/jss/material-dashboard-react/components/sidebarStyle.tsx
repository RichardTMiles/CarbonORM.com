...
import {PositionProperty, TextTransformProperty, TextAlignProperty, FontWeightProperty, FloatProperty} from "csstype";

const sidebarStyle: StyleRulesCallback<any,any> = theme => ({
    drawerPaper: {
        border: "none",
    ...
    list: {
        ...
        marginBottom: "0",
        listStyle: "none",
        position: "unset" as PositionProperty
    },
    item: {
        position: "relative" as PositionProperty,
        display: "block",
