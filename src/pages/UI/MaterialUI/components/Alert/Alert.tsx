...
export default function Alert() {
    ...
    return <Popup handleClose={handleClose}>
        <div className={classNames("model-content", styles.rounded0, styles.border0)} style={{
            ...
            <div className={classNames(styles.modalBody, styles.border0, styles.bgGrayLight, styles.textWhite)}>
            ...
            {undefined !== alert.buttons &&
                <div className={classNames(styles.modalFooter, styles.bgGrayLight, styles.border0, styles.rounded0)}>
                    {alert.footerText &&
