...
class HeaderLinks extends React.Component<WithStyles<typeof headerLinksStyle>, { open: boolean }> {
    state = {
        open: false
    };
    handleToggle = () => {
            ...
            <div>
                ...
                <div className={classes.manager}>
                    ...
                    >
                        ...
                        {mdUp ? null : <p onClick={this.handleToggle} className={classes.linkText}>
                            Notification
                        </p>}
                    </Button>
                    <Poppers
                ...
                >
                    ...
                    {mdUp ? null : <p className={classes.linkText}>Profile</p>}
                </Button>
            </div>
        );
    }
