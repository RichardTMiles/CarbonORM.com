...
import {ContentHeader} from 'pages/UI/Bootstrap/AdminLTE/components';
import {PfButton, PfImage} from '@profabric/react-components';
import styled from 'styled-components';

import ActivityTab from 'pages/UI/Bootstrap/AdminLTE/pages/profile/ActivityTab';
import TimelineTab from 'pages/UI/Bootstrap/AdminLTE/pages/profile/TimelineTab';
import SettingsTab from 'pages/UI/Bootstrap/AdminLTE/pages/profile/SettingsTab';
                ...
                <div className="card-body box-profile">
                  ...
                  <ul className="list-group list-group-unbordered mb-3">
                    <li className="list-group-item">
                      <b>header.user.followers</b>

                      <span className="float-right">1,322</span>
                    </li>
                    <li className="list-group-item">
                      <b>views.user.following</b>
                      <span className="float-right">543</span>
                    </li>
                    <li className="list-group-item">
                      <b>header.user.friends</b>
