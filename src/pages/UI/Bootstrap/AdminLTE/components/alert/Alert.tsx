    ...
    return <Popup handleClose={handleClose}>
        <div className={classNames("model-content", dig.rounded0, dig.border0)} style={{
            ...
            <div className={classNames(dig.modalHeader, dig.rounded0, dig.border0, {
                ...
                [dig.bgPrimary]: "info" === alert.icon || alert.icon === undefined || alert.icon === null,
                [dig.bgSuccess]: "success" === alert.icon,
                [dig.bgWarning]: "warning" === alert.icon,
                [dig.bgDanger]: "error" === alert.icon, // TODO - change to red
            ...
            <div className={classNames(dig.modalBody, dig.border0, dig.bgGrayLight, dig.textWhite)}>
            ...
            {undefined !== alert.buttons &&
                <div className={classNames(dig.modalFooter, dig.bgGrayLight, dig.border0, dig.rounded0)}>
                    ...
                    {alert.buttons?.map((button: iAlertButtonOptions, index: number) => {
                        ...
                        return <button key={index}
                                       className={classNames(dig.btn, dig.btnLg, {
                                           ...
                                           [dig.btnSuccess]: "success" === button.color,
                                           [dig.btnDanger]: "danger" === button.color,
                                           [dig.btnPrimary]: "primary" === button.color,
                                           [dig.btnWarning]: "warning" === button.color,
