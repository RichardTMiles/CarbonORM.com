...
import {
  ...
  toggleMenuItemFlat,
  toggleSidebarMenu
} from 'pages/UI/Bootstrap/AdminLTE/store/reducers/ui';
import {
  NAVBAR_DARK_VARIANTS,
  NAVBAR_LIGHT_VARIANTS,
  SIDEBAR_DARK_SKINS,
  SIDEBAR_LIGHT_SKINS
} from 'pages/UI/Bootstrap/AdminLTE/utils/themes';
import useScrollPosition from 'pages/UI/Bootstrap/AdminLTE/hooks/useScrollPosition';
