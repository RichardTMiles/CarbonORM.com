...
import {setWindowClass} from 'pages/UI/AdminLTE/utils/helpers';
...
import {
    ...
    //authLogin,
    facebookLogin,
} from 'pages/UI/AdminLTE/utils/oidc-providers';
import {setAuthentication} from 'pages/UI/AdminLTE/store/reducers/auth';
